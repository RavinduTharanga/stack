...
#define CONFIGURE_ARGS " '--prefix=/opt/bitnami/postgresql' '--with-libedit-preferred' '--with-openssl' '--with-libxml' '--with-libxslt' '--with-readline' '--with-icu' '--with-uuid=e2fs' '--with-ldap' 'CFLAGS=-O2' 'CXXFLAGS=-O2' '--with-lz4' 'CC=gcc' 'LDFLAGS=-Wl,-rpath=/opt/bitnami/common/lib -L/opt/bitnami/common/lib -Wl,-rpath=/opt/bitnami/postgresql/lib -L/opt/bitnami/postgresql/lib' 'CPPFLAGS=-I/opt/bitnami/common/include -I/opt/bitnami/postgresql/include'"
...
#define PG_VERSION_STR "PostgreSQL 14.8 on x86_64-pc-linux-gnu, compiled by gcc (Debian 10.2.1-6) 10.2.1 20210110, 64-bit"
