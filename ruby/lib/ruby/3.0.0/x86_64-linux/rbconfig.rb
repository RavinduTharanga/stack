...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/bitnami/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/bitnami/ruby' '--enable-pthread' '--disable-install-doc' '--with-readline' '--with-openssl' 'CC=gcc' 'LDFLAGS=-Wl,-rpath=/opt/bitnami/rbenv/lib -L/opt/bitnami/rbenv/lib -Wl,-rpath=/opt/bitnami/ruby/lib -L/opt/bitnami/ruby/lib' 'CPPFLAGS=-I/opt/bitnami/rbenv/include -I/opt/bitnami/ruby/include' 'CFLAGS=-s'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/bitnami/ruby"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath=/opt/bitnami/rbenv/lib -L/opt/bitnami/rbenv/lib -Wl,-rpath=/opt/bitnami/ruby/lib -L/opt/bitnami/ruby/lib -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (Debian 10.2.1-6) 10.2.1 20210110\nCopyright (C) 2020 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CFLAGS"] = "-s"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/bitnami/rbenv/include -I/opt/bitnami/ruby/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath=/opt/bitnami/rbenv/lib -L/opt/bitnami/rbenv/lib -Wl,-rpath=/opt/bitnami/ruby/lib -L/opt/bitnami/ruby/lib -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
  CONFIG["CXXFLAGS"] = ""
